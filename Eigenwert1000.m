...
b = 500; % Blockgroesse (Teilmatrizengroesse) MUSS MIT n KOMPATIEBEL SEIN
...
csvwrite("TeilmatrixGroesse1000.csv", WerteDurchschnitt(1:8, 1))
csvwrite("ZeitTeil1000.csv", WerteDurchschnitt(1:8, 2))
csvwrite("ZeitOriginal1000.csv", WerteDurchschnitt(1:8, 3))